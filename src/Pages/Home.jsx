...
import MobileBG from "../Assets/TEDX m.mp4"
  ...
  return (
    <div className="w-[100%] h-[100%]">
        ...
        <section className="relative w-[100%] h-[100vh]">
            ...
            <video src={MobileBG} autoPlay loop muted className="absolute top-0 h-[100%] w-[100%] object-cover block lg:hidden"/>
        </section>
        ...
        <section className=" w-[94%] sm:w-[90%] mx-auto h-[100%] bg-[#ffffff] mt-8 pt-8 flex flex-col items-center justify-center gap-y-8 sm:gap-y-10 font-[Poppins]">
            ...
            <div className="flex flex-col items-start justify-center gap-y-4">
                <p className='font-[Poppins] font-[500] text-[20px] sm:text-[22px] text-[#0B0B0B] leading-[28px] sm:leading-[32px]'>TED is a nonprofit organization devoted to Ideas Worth Spreading. Started as a four-day conference in California 30 years ago, TED has grown to support its mission with multiple initiatives. The two annual TED Conferences invite the world’s leading thinkers and doers to speak for 18 minutes or less. Many of these talks are then made available, free, at TED.com. TED speakers have included Bill Gates, Jane Goodall, Elizabeth Gilbert, Sir Richard Branson, Nandan Nilekani, Philippe Starck, Ngozi Okonjo-Iweala, Sal Khan and Daniel Kahneman.</p>
                <p className="font-[Poppins] font-[500] text-[20px] sm:text-[22px] text-[#0B0B0B] leading-[28px] sm:leading-[32px]">The annual TED Conference takes place each spring in Vancouver, British Columbia. TED’s media initiatives include TED.com, where new TED Talks are posted daily; TED Translators, which provides subtitles and interactive transcripts as well as translations from volunteers worldwide; the educational initiative TED-Ed. TED has established The Audacious Project that takes a collaborative approach to funding ideas with the potential to create change at thrilling scale; TEDx, which supports individuals or groups in hosting local, self- organized TED-style events around the world, and the TED Fellows program, helping world-changing innovators from around the globe to amplify the impact of their remarkable projects and activities. Follow TED on Twitter <a href="https://twitter.com/TEDTalks" className='text-[#EB0028] underline font-[600]'>https://twitter.com/TEDTalks</a> or on Facebook at <a href='https://www.facebook.com/TED' className='text-[#EB0028] underline font-[600]'>https://www.facebook.com/TED</a></p>
            </div>
        </section>
        ...
        <section className='font-[Poppins] w-[100%] mx-auto h-[100%] mt-10 py-8 themeBG'>
            ...
            <div className="w-[100%] h-[100%] flex flex-col lg:flex-row items-center justify-center px-6 lg:px-10">
        ...
        <section className='w-[100%] h-[100%] bg-[#0B0B0B] py-8 gap-y-6 sm:gap-y-8 px-6'>
            ...
            <div className="grid grid-rows-8 grid-col-1 sm:grid-cols-2 sm:grid-rows-4 lg:grid-cols-3 xl:grid-cols-4 gap-x-6 gap-y-8 sm:gap-y-6 lg:grid-rows-3 xl:grid-rows-2 mt-8">
                {
