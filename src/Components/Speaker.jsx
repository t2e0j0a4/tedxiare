...
const Speaker = (props) => {
    ...
    return (
        <div className='w-[270px] sm:w-[290px] h-[320px] relative mx-auto '>
            <div className="w-[100%] flex relative justify-center items-center">
                <img src={image} alt={name} className='w-[100%] h-[320px] object-cover object-top'/>
            ...
            <div className="w-[100%] z-[100] absolute bottom-0 h-auto  bg-[#0B0B0B] bg-opacity-80 flex flex-col items-center justify-center">
                ...
                <span className='text-[16px] bg-[#0B0B0B] w-[100%] pt-1 font-[700] leading-[24px] text-[#EB0028] font-[Poppins] cursor-default tracking-wider text-opacity-[0.8] text-center bg-opacity-90'>{role}</span>
            </div>
        </div>
    )
}
