    ...
    return (
        <div className='w-[180px] sm:w-[250px] h-[280px] speakerWidth sm:h-[350px] relative mx-auto my-2'>
            ...
            <div className="w-[100%] z-[100] absolute bottom-0 h-auto  bg-[#0B0B0B] bg-opacity-80 flex flex-col items-center justify-center">
                <span className='w-[100%] text-[20px] font-[500] leading-[26px] py-2 text-[#ffffff] hover:bg-[#EB0028] hover:bg-opacity-60 cursor-default font-[Poppins] tracking-wider text-center'>{name}</span>
