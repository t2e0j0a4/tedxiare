...
const Speaker = (props) => {
    ...
    const {name,role,linkedin,instagram,image} = props;

    return (
        <div className='w-[180px] sm:w-[250px] h-[280px] speakerWidth sm:h-[350px] relative mx-auto my-2'>
            <div className="w-[100%] flex relative justify-center items-center">
                ...
                <div className="absolute top-[12px] sm:top-0 right-[-14px] sm:right-0 flex flex-col gap-y-3 sm:mr-4 sm:mt-4">
                    ...
                    <a id='instagram' href={instagram} target="_blank" rel="noreferrer" className='bg-[#EB0028] sm:bg-[#0B0B0B] hover:text-[#1DA1F2] hover:bg-[#0B0B0B] hover:sm:bg-[#0B0B0B] p-[6px] flex justify-center items-center text-[#ffffff] rounded-[50%]'><FaInstagram fontSize='16px'/></a>
                </div>
            </div>
