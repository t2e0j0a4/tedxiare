    ...
    return (
        <nav className=' w-[100%] h-[77px] bg-[#000000] flex flex-row items-center justify-between px-6 sm:px-20 font-[Poppins]'>
            ...
            <ul className={`flex flex-row items-center md:items-center justify-end gap-x-8 absolute w-[100%] md:w-auto navBG h-[77px] md:h-auto ${menuToggle ? 'top-[77px] z-10' : 'top-0 -z-10'} left-0 pr-12 sm:pr-16 md:z-[1] md:pr-0 md:static transition-all`}>
                ...
                <li className=''><a target="_blank" rel="noreferrer" href="https://docs.google.com/forms/d/1arFlz1XgGeEpTj1ykSjIoagUoSCW0ExX_Nvoz6FNhuY/viewform?edit_requested=true" onClick={()=>{setMenuToggle(false)}}  className='w-[92px] h-[32px] bg-[#EB0028] text-[#ffffff] hover:bg-[#ffffff] hover:text-[#EB0028] text-[16px] font-[600] px-[10px] py-[3px] cursor-default sm:cursor-pointer'>Register</a></li>
            </ul>
